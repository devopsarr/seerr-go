...
**DnsCache** | Pointer to [**GetCache2XXResponseDnsCache**](GetCache2XXResponseDnsCache.md) |  | [optional] 
...
`func (o *GetCache2XXResponse) GetDnsCache() GetCache2XXResponseDnsCache`

GetDnsCache returns the DnsCache field if non-nil, zero value otherwise.

### GetDnsCacheOk

`func (o *GetCache2XXResponse) GetDnsCacheOk() (*GetCache2XXResponseDnsCache, bool)`
...
`func (o *GetCache2XXResponse) SetDnsCache(v GetCache2XXResponseDnsCache)`

SetDnsCache sets DnsCache field to given value.

### HasDnsCache

`func (o *GetCache2XXResponse) HasDnsCache() bool`
