...
**AppDataPermissions** | Pointer to **bool** |  | [optional] 
...
### GetAppDataPermissions

`func (o *GetStatusAppdata2XXResponse) GetAppDataPermissions() bool`

GetAppDataPermissions returns the AppDataPermissions field if non-nil, zero value otherwise.

### GetAppDataPermissionsOk

`func (o *GetStatusAppdata2XXResponse) GetAppDataPermissionsOk() (*bool, bool)`

GetAppDataPermissionsOk returns a tuple with the AppDataPermissions field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAppDataPermissions

`func (o *GetStatusAppdata2XXResponse) SetAppDataPermissions(v bool)`

SetAppDataPermissions sets AppDataPermissions field to given value.

### HasAppDataPermissions

`func (o *GetStatusAppdata2XXResponse) HasAppDataPermissions() bool`

HasAppDataPermissions returns a boolean if a field has been set.
