...
func main() {
	createIssueRequest := *seerrClient.NewCreateIssueRequest() // CreateIssueRequest | 
...
func main() {
	...
	createIssueCommentRequest := *seerrClient.NewCreateIssueCommentRequest("Message_example") // CreateIssueCommentRequest | 
