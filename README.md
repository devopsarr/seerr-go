...
- API version: v3.4.1
- Package version: 0.2.1 <!--- x-release-please-version -->
...
Similar rules for overriding default operation server index and variables applies by using `seerr.ContextOperationServerIndices` and `seerr.ContextOperationServerVariables` context maps.
...
------------ | ------------- | ------------- | -------------
*AuthAPI* | [**CreateAuthJellyfin**](docs/AuthAPI.md#createauthjellyfin) | **Post** /auth/jellyfin | Sign in using a Jellyfin username and password
*AuthAPI* | [**CreateAuthJellyfinQuickconnectAuthenticate**](docs/AuthAPI.md#createauthjellyfinquickconnectauthenticate) | **Post** /auth/jellyfin/quickconnect/authenticate | Authenticate with Quick Connect
*AuthAPI* | [**CreateAuthJellyfinQuickconnectInitiate**](docs/AuthAPI.md#createauthjellyfinquickconnectinitiate) | **Post** /auth/jellyfin/quickconnect/initiate | Initiate Jellyfin Quick Connect
...
*AuthAPI* | [**GetAuthJellyfinQuickconnectCheck**](docs/AuthAPI.md#getauthjellyfinquickconnectcheck) | **Get** /auth/jellyfin/quickconnect/check | Check Quick Connect authorization status
*AuthAPI* | [**GetAuthMe**](docs/AuthAPI.md#getauthme) | **Get** /auth/me | Get logged-in user
*BlocklistAPI* | [**CreateBlacklist**](docs/BlocklistAPI.md#createblacklist) | **Post** /blacklist | Add media to blocklist
*BlocklistAPI* | [**CreateBlocklist**](docs/BlocklistAPI.md#createblocklist) | **Post** /blocklist | Add media to blocklist
*BlocklistAPI* | [**CreateBlocklistCollectionByCollectionId**](docs/BlocklistAPI.md#createblocklistcollectionbycollectionid) | **Post** /blocklist/collection/{collectionId} | Add collection to blocklist
*BlocklistAPI* | [**DeleteBlacklist**](docs/BlocklistAPI.md#deleteblacklist) | **Delete** /blacklist/{tmdbId} | Remove media from blocklist
*BlocklistAPI* | [**DeleteBlocklist**](docs/BlocklistAPI.md#deleteblocklist) | **Delete** /blocklist/{tmdbId} | Remove media from blocklist
*BlocklistAPI* | [**DeleteBlocklistCollection**](docs/BlocklistAPI.md#deleteblocklistcollection) | **Delete** /blocklist/collection/{collectionId} | Remove collection from blocklist
*BlocklistAPI* | [**GetBlacklist**](docs/BlocklistAPI.md#getblacklist) | **Get** /blacklist | Returns blocklisted items
*BlocklistAPI* | [**GetBlacklistByTmdbId**](docs/BlocklistAPI.md#getblacklistbytmdbid) | **Get** /blacklist/{tmdbId} | Get media from blocklist
*BlocklistAPI* | [**GetBlocklist**](docs/BlocklistAPI.md#getblocklist) | **Get** /blocklist | Returns blocklisted items
*BlocklistAPI* | [**GetBlocklistByTmdbId**](docs/BlocklistAPI.md#getblocklistbytmdbid) | **Get** /blocklist/{tmdbId} | Get media from blocklist
...
*MediaAPI* | [**DeleteMediaFile**](docs/MediaAPI.md#deletemediafile) | **Delete** /media/{mediaId}/file | Delete media file
...
*OtherAPI* | [**GetCertificationsMovie**](docs/OtherAPI.md#getcertificationsmovie) | **Get** /certifications/movie | Get movie certifications
*OtherAPI* | [**GetCertificationsTv**](docs/OtherAPI.md#getcertificationstv) | **Get** /certifications/tv | Get TV certifications
...
*OverrideruleAPI* | [**CreateOverriderule**](docs/OverrideruleAPI.md#createoverriderule) | **Post** /overrideRule | Create override rule
*OverrideruleAPI* | [**DeleteOverriderule**](docs/OverrideruleAPI.md#deleteoverriderule) | **Delete** /overrideRule/{ruleId} | Delete override rule by ID
*OverrideruleAPI* | [**ListOverriderule**](docs/OverrideruleAPI.md#listoverriderule) | **Get** /overrideRule | Get override rules
*OverrideruleAPI* | [**UpdateOverriderule**](docs/OverrideruleAPI.md#updateoverriderule) | **Put** /overrideRule/{ruleId} | Update override rule
...
*PublicAPI* | [**GetStatus**](docs/PublicAPI.md#getstatus) | **Get** /status | Get Seerr status
...
*SettingsAPI* | [**CreateCacheDnsFlush**](docs/SettingsAPI.md#createcachednsflush) | **Post** /settings/cache/dns/{dnsEntry}/flush | Flush a specific DNS cache entry
...
*SettingsAPI* | [**CreateJellyfin**](docs/SettingsAPI.md#createjellyfin) | **Post** /settings/jellyfin | Update Jellyfin settings
*SettingsAPI* | [**CreateJellyfinSync**](docs/SettingsAPI.md#createjellyfinsync) | **Post** /settings/jellyfin/sync | Start full Jellyfin library sync
...
*SettingsAPI* | [**CreateNetwork**](docs/SettingsAPI.md#createnetwork) | **Post** /settings/network | Update network settings
...
*SettingsAPI* | [**CreateNotificationsNtfy**](docs/SettingsAPI.md#createnotificationsntfy) | **Post** /settings/notifications/ntfy | Update ntfy.sh notification settings
...
*SettingsAPI* | [**GetJellyfin**](docs/SettingsAPI.md#getjellyfin) | **Get** /settings/jellyfin | Get Jellyfin settings
*SettingsAPI* | [**GetJellyfinSync**](docs/SettingsAPI.md#getjellyfinsync) | **Get** /settings/jellyfin/sync | Get status of full Jellyfin library sync
*SettingsAPI* | [**GetMain**](docs/SettingsAPI.md#getmain) | **Get** /settings/main | Get main settings
*SettingsAPI* | [**GetMetadatas**](docs/SettingsAPI.md#getmetadatas) | **Get** /settings/metadatas | Get Metadata settings
*SettingsAPI* | [**GetNetwork**](docs/SettingsAPI.md#getnetwork) | **Get** /settings/network | Get network settings
...
*SettingsAPI* | [**GetNotificationsNtfy**](docs/SettingsAPI.md#getnotificationsntfy) | **Get** /settings/notifications/ntfy | Get ntfy.sh notification settings
...
*SettingsAPI* | [**ListJellyfinLibrary**](docs/SettingsAPI.md#listjellyfinlibrary) | **Get** /settings/jellyfin/library | Get Jellyfin libraries
*SettingsAPI* | [**ListJellyfinUsers**](docs/SettingsAPI.md#listjellyfinusers) | **Get** /settings/jellyfin/users | Get Jellyfin Users
...
*SettingsAPI* | [**PutMetadatas**](docs/SettingsAPI.md#putmetadatas) | **Put** /settings/metadatas | Update Metadata settings
*SettingsAPI* | [**TestMetadatas**](docs/SettingsAPI.md#testmetadatas) | **Post** /settings/metadatas/test | Test Provider configuration
...
*SettingsAPI* | [**TestNotificationsNtfy**](docs/SettingsAPI.md#testnotificationsntfy) | **Post** /settings/notifications/ntfy/test | Test ntfy.sh settings
...
*TvAPI* | [**GetTvSeasonBySeasonNumber**](docs/TvAPI.md#gettvseasonbyseasonnumber) | **Get** /tv/{tvId}/season/{seasonNumber} | Get season details and episode list
...
*UsersAPI* | [**CreateUserImportFromJellyfin**](docs/UsersAPI.md#createuserimportfromjellyfin) | **Post** /user/import-from-jellyfin | Import all users from Jellyfin
...
*UsersAPI* | [**CreateUserSettingsLinkedAccountsJellyfin**](docs/UsersAPI.md#createusersettingslinkedaccountsjellyfin) | **Post** /user/{userId}/settings/linked-accounts/jellyfin | Link the provided Jellyfin account to the current user
*UsersAPI* | [**CreateUserSettingsLinkedAccountsJellyfinQuickconnect**](docs/UsersAPI.md#createusersettingslinkedaccountsjellyfinquickconnect) | **Post** /user/{userId}/settings/linked-accounts/jellyfin/quickconnect | Link Jellyfin/Emby account with Quick Connect
*UsersAPI* | [**CreateUserSettingsLinkedAccountsPlex**](docs/UsersAPI.md#createusersettingslinkedaccountsplex) | **Post** /user/{userId}/settings/linked-accounts/plex | Link the provided Plex account to the current user
...
*UsersAPI* | [**DeleteUserSettingsLinkedAccountsJellyfin**](docs/UsersAPI.md#deleteusersettingslinkedaccountsjellyfin) | **Delete** /user/{userId}/settings/linked-accounts/jellyfin | Remove the linked Jellyfin account for a user
*UsersAPI* | [**DeleteUserSettingsLinkedAccountsPlex**](docs/UsersAPI.md#deleteusersettingslinkedaccountsplex) | **Delete** /user/{userId}/settings/linked-accounts/plex | Remove the linked Plex account for a user
...
*UsersAPI* | [**GetUserJellyfinByJellyfinUserId**](docs/UsersAPI.md#getuserjellyfinbyjellyfinuserid) | **Get** /user/jellyfin/{jellyfinUserId} | Get user by Jellyfin user ID
...
*WatchlistAPI* | [**CreateWatchlist**](docs/WatchlistAPI.md#createwatchlist) | **Post** /watchlist | Add media to watchlist
*WatchlistAPI* | [**DeleteWatchlist**](docs/WatchlistAPI.md#deletewatchlist) | **Delete** /watchlist/{tmdbId} | Delete watchlist item
...
## Documentation For Models
 ...
 - [CreateAuthJellyfinQuickconnectAuthenticateRequest](docs/CreateAuthJellyfinQuickconnectAuthenticateRequest.md)
 - [CreateAuthJellyfinQuickconnectInitiate2XXResponse](docs/CreateAuthJellyfinQuickconnectInitiate2XXResponse.md)
 ...
 - [GetAuthJellyfinQuickconnectCheck2XXResponse](docs/GetAuthJellyfinQuickconnectCheck2XXResponse.md)
 ...
 - [GetCertificationsTv500Response](docs/GetCertificationsTv500Response.md)
 ...
 - [GetKeywordByKeywordId500Response](docs/GetKeywordByKeywordId500Response.md)
