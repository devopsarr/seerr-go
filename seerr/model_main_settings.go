...
type MainSettings struct {
	...
	EnableSpecialEpisodes *bool `json:"enableSpecialEpisodes,omitempty"`
	VersionCheck *bool `json:"versionCheck,omitempty"`
...
// GetEnableSpecialEpisodes returns the EnableSpecialEpisodes field value if set, zero value otherwise.
func (o *MainSettings) GetEnableSpecialEpisodes() bool {
	if o == nil || IsNil(o.EnableSpecialEpisodes) {
		var ret bool
		return ret
	}
	return *o.EnableSpecialEpisodes
}

// GetEnableSpecialEpisodesOk returns a tuple with the EnableSpecialEpisodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MainSettings) GetEnableSpecialEpisodesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableSpecialEpisodes) {
		return nil, false
	}
	return o.EnableSpecialEpisodes, true
}
...
// SetEnableSpecialEpisodes gets a reference to the given bool and assigns it to the EnableSpecialEpisodes field.
func (o *MainSettings) SetEnableSpecialEpisodes(v bool) {
	o.EnableSpecialEpisodes = &v
}

// GetVersionCheck returns the VersionCheck field value if set, zero value otherwise.
func (o *MainSettings) GetVersionCheck() bool {
	if o == nil || IsNil(o.VersionCheck) {
		var ret bool
		return ret
	}
...
// GetVersionCheckOk returns a tuple with the VersionCheck field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MainSettings) GetVersionCheckOk() (*bool, bool) {
	if o == nil || IsNil(o.VersionCheck) {
		return nil, false
	}
	return o.VersionCheck, true
}
...
// SetVersionCheck gets a reference to the given bool and assigns it to the VersionCheck field.
...
func (o MainSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnableSpecialEpisodes) {
		toSerialize["enableSpecialEpisodes"] = o.EnableSpecialEpisodes
	}
	if !IsNil(o.VersionCheck) {
		toSerialize["versionCheck"] = o.VersionCheck
	}
...
func (o *MainSettings) UnmarshalJSON(data []byte) (err error) {
	...
	*o = MainSettings(varMainSettings)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "mediaServerType")
		delete(additionalProperties, "newPlexLogin")
		delete(additionalProperties, "defaultPermissions")
		delete(additionalProperties, "enableSpecialEpisodes")
		delete(additionalProperties, "versionCheck")
