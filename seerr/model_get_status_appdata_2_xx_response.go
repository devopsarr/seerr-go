...
type GetStatusAppdata2XXResponse struct {
	...
	AppDataPermissions *bool `json:"appDataPermissions,omitempty"`
...
// GetAppDataPermissions returns the AppDataPermissions field value if set, zero value otherwise.
func (o *GetStatusAppdata2XXResponse) GetAppDataPermissions() bool {
	if o == nil || IsNil(o.AppDataPermissions) {
		var ret bool
		return ret
	}
	return *o.AppDataPermissions
}

// GetAppDataPermissionsOk returns a tuple with the AppDataPermissions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetStatusAppdata2XXResponse) GetAppDataPermissionsOk() (*bool, bool) {
	if o == nil || IsNil(o.AppDataPermissions) {
		return nil, false
	}
	return o.AppDataPermissions, true
}
...
// SetAppDataPermissions gets a reference to the given bool and assigns it to the AppDataPermissions field.
func (o *GetStatusAppdata2XXResponse) SetAppDataPermissions(v bool) {
	o.AppDataPermissions = &v
}
...
func (o GetStatusAppdata2XXResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AppDataPermissions) {
		toSerialize["appDataPermissions"] = o.AppDataPermissions
	}
...
func (o *GetStatusAppdata2XXResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GetStatusAppdata2XXResponse(varGetStatusAppdata2XXResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "appDataPermissions")
