...
type ApiDeleteMediaFileRequest struct {
	ctx context.Context
	ApiService *MediaAPIService
	mediaId string
	is4k *bool
...
func (r ApiDeleteMediaFileRequest) Is4k(is4k bool) ApiDeleteMediaFileRequest {
	r.is4k = &is4k
	return r
}

func (r ApiDeleteMediaFileRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteMediaFileExecute(r)
}
...
Removes a media file from radarr/sonarr. The `ADMIN` permission is required to perform this action.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param mediaId Media ID
 @return ApiDeleteMediaFileRequest
*/
func (a *MediaAPIService) DeleteMediaFile(ctx context.Context, mediaId string) ApiDeleteMediaFileRequest {
	return ApiDeleteMediaFileRequest{
		ApiService: a,
		ctx: ctx,
		mediaId: mediaId,
...
// Execute executes the request
func (a *MediaAPIService) DeleteMediaFileExecute(r ApiDeleteMediaFileRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MediaAPIService.DeleteMediaFile")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
