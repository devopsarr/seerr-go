...
func (r ApiGetDiscoverMoviesRequest) ExcludeKeywords(excludeKeywords string) ApiGetDiscoverMoviesRequest {
...
func (r ApiGetDiscoverMoviesRequest) Certification(certification string) ApiGetDiscoverMoviesRequest {
	r.certification = &certification
	return r
}

// Minimum certification to filter by (used when certificationMode is &#39;range&#39;)
func (r ApiGetDiscoverMoviesRequest) CertificationGte(certificationGte string) ApiGetDiscoverMoviesRequest {
	r.certificationGte = &certificationGte
	return r
}

// Maximum certification to filter by (used when certificationMode is &#39;range&#39;)
func (r ApiGetDiscoverMoviesRequest) CertificationLte(certificationLte string) ApiGetDiscoverMoviesRequest {
	r.certificationLte = &certificationLte
	return r
}

// Country code for the certification system (e.g., US, GB, CA)
func (r ApiGetDiscoverMoviesRequest) CertificationCountry(certificationCountry string) ApiGetDiscoverMoviesRequest {
	r.certificationCountry = &certificationCountry
	return r
}

// Determines whether to use exact certification matching or a certification range (internal use only, not sent to TMDB API)
func (r ApiGetDiscoverMoviesRequest) CertificationMode(certificationMode string) ApiGetDiscoverMoviesRequest {
	r.certificationMode = &certificationMode
	return r
}
...
func (a *SearchAPIService) GetDiscoverMoviesExecute(r ApiGetDiscoverMoviesRequest) (*GetDiscoverMovies2XXResponse, *http.Response, error) {
	...
	if r.excludeKeywords != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "excludeKeywords", r.excludeKeywords, "form", "")
	}
	if r.sortBy != nil {
	...
	if r.certification != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "certification", r.certification, "form", "")
	}
	if r.certificationGte != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "certificationGte", r.certificationGte, "form", "")
	}
	if r.certificationLte != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "certificationLte", r.certificationLte, "form", "")
	}
	if r.certificationCountry != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "certificationCountry", r.certificationCountry, "form", "")
	}
	if r.certificationMode != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "certificationMode", r.certificationMode, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiGetDiscoverTrendingRequest) MediaType(mediaType string) ApiGetDiscoverTrendingRequest {
	r.mediaType = &mediaType
	return r
}

func (r ApiGetDiscoverTrendingRequest) TimeWindow(timeWindow string) ApiGetDiscoverTrendingRequest {
...
func (a *SearchAPIService) GetDiscoverTrendingExecute(r ApiGetDiscoverTrendingRequest) (*GetSearch2XXResponse, *http.Response, error) {
	...
	if r.timeWindow != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "timeWindow", r.timeWindow, "form", "")
	} else {
		var defaultValue string = "day"
		parameterAddToHeaderOrQuery(localVarQueryParams, "timeWindow", defaultValue, "form", "")
...
// Comma-separated list of keyword IDs to exclude from results
func (r ApiGetDiscoverTvRequest) ExcludeKeywords(excludeKeywords string) ApiGetDiscoverTvRequest {
	r.excludeKeywords = &excludeKeywords
	return r
}
...
func (r ApiGetDiscoverTvRequest) Status(status string) ApiGetDiscoverTvRequest {
	r.status = &status
	return r
}

// Exact certification to filter by (used when certificationMode is &#39;exact&#39;)
func (r ApiGetDiscoverTvRequest) Certification(certification string) ApiGetDiscoverTvRequest {
	r.certification = &certification
	return r
}

// Minimum certification to filter by (used when certificationMode is &#39;range&#39;)
func (r ApiGetDiscoverTvRequest) CertificationGte(certificationGte string) ApiGetDiscoverTvRequest {
	r.certificationGte = &certificationGte
	return r
}

// Maximum certification to filter by (used when certificationMode is &#39;range&#39;)
func (r ApiGetDiscoverTvRequest) CertificationLte(certificationLte string) ApiGetDiscoverTvRequest {
	r.certificationLte = &certificationLte
	return r
}

// Country code for the certification system (e.g., US, GB, CA)
func (r ApiGetDiscoverTvRequest) CertificationCountry(certificationCountry string) ApiGetDiscoverTvRequest {
	r.certificationCountry = &certificationCountry
	return r
}

// Determines whether to use exact certification matching or a certification range (internal use only, not sent to TMDB API)
func (r ApiGetDiscoverTvRequest) CertificationMode(certificationMode string) ApiGetDiscoverTvRequest {
	r.certificationMode = &certificationMode
	return r
}
