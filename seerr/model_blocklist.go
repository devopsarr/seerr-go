...
func (o *Blocklist) UnmarshalJSON(data []byte) (err error) {
	varBlocklist := _Blocklist{}

	err = json.Unmarshal(data, &varBlocklist)

	if err != nil {
		return err
	}

	*o = Blocklist(varBlocklist)
