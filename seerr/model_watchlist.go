...
func (o *Watchlist) UnmarshalJSON(data []byte) (err error) {
	varWatchlist := _Watchlist{}

	err = json.Unmarshal(data, &varWatchlist)

	if err != nil {
		return err
	}

	*o = Watchlist(varWatchlist)
