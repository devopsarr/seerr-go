...
func (o *TelegramSettingsOptions) GetMessageThreadId() string {
...
// and a boolean to check if the value has been set.
func (o *TelegramSettingsOptions) GetMessageThreadIdOk() (*string, bool) {
	if o == nil || IsNil(o.MessageThreadId) {
		return nil, false
	}
...
func (o *TelegramSettingsOptions) HasMessageThreadId() bool {
	if o != nil && !IsNil(o.MessageThreadId) {
		return true
	}
...
// SetMessageThreadId gets a reference to the given string and assigns it to the MessageThreadId field.
func (o *TelegramSettingsOptions) SetMessageThreadId(v string) {
	o.MessageThreadId = &v
}
...
func (o TelegramSettingsOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MessageThreadId) {
		toSerialize["messageThreadId"] = o.MessageThreadId
	}
...
func (o *TelegramSettingsOptions) UnmarshalJSON(data []byte) (err error) {
	...
	*o = TelegramSettingsOptions(varTelegramSettingsOptions)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "messageThreadId")
