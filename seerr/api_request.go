...
func (r ApiGetRequestRequest) SortDirection(sortDirection string) ApiGetRequestRequest {
...
func (r ApiGetRequestRequest) MediaType(mediaType string) ApiGetRequestRequest {
