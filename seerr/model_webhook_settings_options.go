...
// GetSupportVariables returns the SupportVariables field value if set, zero value otherwise.
func (o *WebhookSettingsOptions) GetSupportVariables() bool {
	if o == nil || IsNil(o.SupportVariables) {
		var ret bool
		return ret
	}
	return *o.SupportVariables
}

// GetSupportVariablesOk returns a tuple with the SupportVariables field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WebhookSettingsOptions) GetSupportVariablesOk() (*bool, bool) {
	if o == nil || IsNil(o.SupportVariables) {
		return nil, false
	}
	return o.SupportVariables, true
}

// HasSupportVariables returns a boolean if a field has been set.
func (o *WebhookSettingsOptions) HasSupportVariables() bool {
	if o != nil && !IsNil(o.SupportVariables) {
		return true
	}
...
// SetSupportVariables gets a reference to the given bool and assigns it to the SupportVariables field.
func (o *WebhookSettingsOptions) SetSupportVariables(v bool) {
	o.SupportVariables = &v
}
...
func (o WebhookSettingsOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SupportVariables) {
		toSerialize["supportVariables"] = o.SupportVariables
	}
...
func (o *WebhookSettingsOptions) UnmarshalJSON(data []byte) (err error) {
	...
	*o = WebhookSettingsOptions(varWebhookSettingsOptions)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "supportVariables")
