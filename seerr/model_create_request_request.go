...
// GetIgnoreQuota returns the IgnoreQuota field value if set, zero value otherwise.
func (o *CreateRequestRequest) GetIgnoreQuota() bool {
	if o == nil || IsNil(o.IgnoreQuota) {
		var ret bool
		return ret
	}
	return *o.IgnoreQuota
}

// GetIgnoreQuotaOk returns a tuple with the IgnoreQuota field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateRequestRequest) GetIgnoreQuotaOk() (*bool, bool) {
	if o == nil || IsNil(o.IgnoreQuota) {
		return nil, false
	}
	return o.IgnoreQuota, true
}
...
// SetIgnoreQuota gets a reference to the given bool and assigns it to the IgnoreQuota field.
...
func (o CreateRequestRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IgnoreQuota) {
		toSerialize["ignoreQuota"] = o.IgnoreQuota
	}
...
func (o *CreateRequestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateRequestRequest(varCreateRequestRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ignoreQuota")
