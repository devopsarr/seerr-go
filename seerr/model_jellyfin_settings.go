...
type _JellyfinSettings JellyfinSettings
...
func (o *JellyfinSettings) UnmarshalJSON(data []byte) (err error) {
	varJellyfinSettings := _JellyfinSettings{}

	err = json.Unmarshal(data, &varJellyfinSettings)

	if err != nil {
		return err
	}

	*o = JellyfinSettings(varJellyfinSettings)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "jellyfinForgotPasswordUrl")
		delete(additionalProperties, "adminUser")
		delete(additionalProperties, "adminPass")
