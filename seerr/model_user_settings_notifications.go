...
type UserSettingsNotifications struct {
	...
	TelegramMessageThreadId NullableString `json:"telegramMessageThreadId,omitempty"`
...
// GetTelegramMessageThreadId returns the TelegramMessageThreadId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UserSettingsNotifications) GetTelegramMessageThreadId() string {
	if o == nil || IsNil(o.TelegramMessageThreadId.Get()) {
		var ret string
		return ret
	}
	return *o.TelegramMessageThreadId.Get()
}

// GetTelegramMessageThreadIdOk returns a tuple with the TelegramMessageThreadId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UserSettingsNotifications) GetTelegramMessageThreadIdOk() (*string, bool) {
	...
	return o.TelegramMessageThreadId.Get(), o.TelegramMessageThreadId.IsSet()
}
...
func (o *UserSettingsNotifications) HasTelegramMessageThreadId() bool {
	if o != nil && o.TelegramMessageThreadId.IsSet() {
		return true
	}
...
// SetTelegramMessageThreadId gets a reference to the given NullableString and assigns it to the TelegramMessageThreadId field.
func (o *UserSettingsNotifications) SetTelegramMessageThreadId(v string) {
	o.TelegramMessageThreadId.Set(&v)
}
// SetTelegramMessageThreadIdNil sets the value for TelegramMessageThreadId to be an explicit nil
func (o *UserSettingsNotifications) SetTelegramMessageThreadIdNil() {
	o.TelegramMessageThreadId.Set(nil)
}
...
func (o *UserSettingsNotifications) UnsetTelegramMessageThreadId() {
	o.TelegramMessageThreadId.Unset()
}
...
func (o UserSettingsNotifications) ToMap() (map[string]interface{}, error) {
	...
	if o.DiscordIds != nil {
		toSerialize["discordIds"] = o.DiscordIds
	}
	...
	if o.TelegramMessageThreadId.IsSet() {
		toSerialize["telegramMessageThreadId"] = o.TelegramMessageThreadId.Get()
	}
...
func (o *UserSettingsNotifications) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UserSettingsNotifications(varUserSettingsNotifications)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "discordIds")
		...
		delete(additionalProperties, "telegramMessageThreadId")
