...
type ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest struct {
	ctx context.Context
	ApiService *UsersAPIService
	userId float32
	createAuthJellyfinQuickconnectAuthenticateRequest *CreateAuthJellyfinQuickconnectAuthenticateRequest
}

func (r ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest) CreateAuthJellyfinQuickconnectAuthenticateRequest(createAuthJellyfinQuickconnectAuthenticateRequest CreateAuthJellyfinQuickconnectAuthenticateRequest) ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest {
	r.createAuthJellyfinQuickconnectAuthenticateRequest = &createAuthJellyfinQuickconnectAuthenticateRequest
	return r
}

func (r ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateUserSettingsLinkedAccountsJellyfinQuickconnectExecute(r)
}

/*
CreateUserSettingsLinkedAccountsJellyfinQuickconnect Link Jellyfin/Emby account with Quick Connect

Links a Jellyfin/Emby account to the user's profile using Quick Connect authentication

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param userId
 @return ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest
*/
func (a *UsersAPIService) CreateUserSettingsLinkedAccountsJellyfinQuickconnect(ctx context.Context, userId float32) ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest {
	return ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest{
		ApiService: a,
		ctx: ctx,
		userId: userId,
...
// Execute executes the request
func (a *UsersAPIService) CreateUserSettingsLinkedAccountsJellyfinQuickconnectExecute(r ApiCreateUserSettingsLinkedAccountsJellyfinQuickconnectRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.CreateUserSettingsLinkedAccountsJellyfinQuickconnect")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/user/{userId}/settings/linked-accounts/jellyfin/quickconnect"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createAuthJellyfinQuickconnectAuthenticateRequest == nil {
		return nil, reportError("createAuthJellyfinQuickconnectAuthenticateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createAuthJellyfinQuickconnectAuthenticateRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
