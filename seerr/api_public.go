...
func (r ApiGetStatusRequest) CheckUpdateAvailable(checkUpdateAvailable bool) ApiGetStatusRequest {
	r.checkUpdateAvailable = &checkUpdateAvailable
	return r
}
...
func (a *PublicAPIService) GetStatusExecute(r ApiGetStatusRequest) (*GetStatus2XXResponse, *http.Response, error) {
	...
	if r.checkUpdateAvailable != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "checkUpdateAvailable", r.checkUpdateAvailable, "form", "")
	}
