...
type ApiGetTvSeasonBySeasonNumberRequest struct {
	ctx context.Context
	ApiService *TvAPIService
	tvId float32
...
func (r ApiGetTvSeasonBySeasonNumberRequest) Language(language string) ApiGetTvSeasonBySeasonNumberRequest {
	r.language = &language
	return r
}

func (r ApiGetTvSeasonBySeasonNumberRequest) Execute() (*Season, *http.Response, error) {
	return r.ApiService.GetTvSeasonBySeasonNumberExecute(r)
}

/*
GetTvSeasonBySeasonNumber Get season details and episode list
...
Returns season details with a list of episodes in a JSON object.
 ...
 @param tvId
 @param seasonNumber
 @return ApiGetTvSeasonBySeasonNumberRequest
*/
func (a *TvAPIService) GetTvSeasonBySeasonNumber(ctx context.Context, tvId float32, seasonNumber float32) ApiGetTvSeasonBySeasonNumberRequest {
	return ApiGetTvSeasonBySeasonNumberRequest{
		ApiService: a,
		ctx: ctx,
		tvId: tvId,
...
// Execute executes the request
//  @return Season
func (a *TvAPIService) GetTvSeasonBySeasonNumberExecute(r ApiGetTvSeasonBySeasonNumberRequest) (*Season, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TvAPIService.GetTvSeasonBySeasonNumber")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tv/{tvId}/season/{seasonNumber}"
	localVarPath = strings.Replace(localVarPath, "{"+"tvId"+"}", url.PathEscape(parameterValueToString(r.tvId, "tvId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"seasonNumber"+"}", url.PathEscape(parameterValueToString(r.seasonNumber, "seasonNumber")), -1)
