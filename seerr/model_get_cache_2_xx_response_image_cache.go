...
type GetCache2XXResponseImageCache struct {
	...
	Avatar *GetCache2XXResponseImageCacheTmdb `json:"avatar,omitempty"`
...
func (o *GetCache2XXResponseImageCache) GetAvatar() GetCache2XXResponseImageCacheTmdb {
...
// and a boolean to check if the value has been set.
func (o *GetCache2XXResponseImageCache) GetAvatarOk() (*GetCache2XXResponseImageCacheTmdb, bool) {
	if o == nil || IsNil(o.Avatar) {
		return nil, false
	}
...
func (o *GetCache2XXResponseImageCache) HasAvatar() bool {
	if o != nil && !IsNil(o.Avatar) {
		return true
	}
...
// SetAvatar gets a reference to the given GetCache2XXResponseImageCacheTmdb and assigns it to the Avatar field.
func (o *GetCache2XXResponseImageCache) SetAvatar(v GetCache2XXResponseImageCacheTmdb) {
	o.Avatar = &v
}
