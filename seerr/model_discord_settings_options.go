...
type DiscordSettingsOptions struct {
	...
	WebhookRoleId *string `json:"webhookRoleId,omitempty"`
...
// GetWebhookRoleId returns the WebhookRoleId field value if set, zero value otherwise.
func (o *DiscordSettingsOptions) GetWebhookRoleId() string {
	if o == nil || IsNil(o.WebhookRoleId) {
		var ret string
		return ret
	}
	return *o.WebhookRoleId
}

// GetWebhookRoleIdOk returns a tuple with the WebhookRoleId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DiscordSettingsOptions) GetWebhookRoleIdOk() (*string, bool) {
	if o == nil || IsNil(o.WebhookRoleId) {
		return nil, false
	}
	return o.WebhookRoleId, true
}

// HasWebhookRoleId returns a boolean if a field has been set.
func (o *DiscordSettingsOptions) HasWebhookRoleId() bool {
	if o != nil && !IsNil(o.WebhookRoleId) {
		return true
	}
...
// SetWebhookRoleId gets a reference to the given string and assigns it to the WebhookRoleId field.
func (o *DiscordSettingsOptions) SetWebhookRoleId(v string) {
	o.WebhookRoleId = &v
}
...
func (o DiscordSettingsOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WebhookRoleId) {
		toSerialize["webhookRoleId"] = o.WebhookRoleId
	}
...
func (o *DiscordSettingsOptions) UnmarshalJSON(data []byte) (err error) {
	...
	*o = DiscordSettingsOptions(varDiscordSettingsOptions)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "webhookRoleId")
