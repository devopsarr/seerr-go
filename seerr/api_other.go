...
type ApiGetCertificationsMovieRequest struct {
	ctx context.Context
	ApiService *OtherAPIService
}

func (r ApiGetCertificationsMovieRequest) Execute() (*CertificationResponse, *http.Response, error) {
	return r.ApiService.GetCertificationsMovieExecute(r)
}

/*
GetCertificationsMovie Get movie certifications

Returns list of movie certifications from TMDB.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCertificationsMovieRequest
*/
func (a *OtherAPIService) GetCertificationsMovie(ctx context.Context) ApiGetCertificationsMovieRequest {
	return ApiGetCertificationsMovieRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OtherAPIService) GetCertificationsMovieExecute(r ApiGetCertificationsMovieRequest) (*CertificationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CertificationResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OtherAPIService.GetCertificationsMovie")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/certifications/movie"
...
type ApiGetCertificationsTvRequest struct {
	ctx context.Context
	ApiService *OtherAPIService
}

func (r ApiGetCertificationsTvRequest) Execute() (*CertificationResponse, *http.Response, error) {
	return r.ApiService.GetCertificationsTvExecute(r)
}

/*
GetCertificationsTv Get TV certifications

Returns list of TV show certifications from TMDB.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCertificationsTvRequest
*/
func (a *OtherAPIService) GetCertificationsTv(ctx context.Context) ApiGetCertificationsTvRequest {
	return ApiGetCertificationsTvRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CertificationResponse
func (a *OtherAPIService) GetCertificationsTvExecute(r ApiGetCertificationsTvRequest) (*CertificationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OtherAPIService.GetCertificationsTv")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/certifications/tv"
