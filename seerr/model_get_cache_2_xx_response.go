...
type GetCache2XXResponse struct {
	...
	DnsCache *GetCache2XXResponseDnsCache `json:"dnsCache,omitempty"`
...
func (o *GetCache2XXResponse) GetDnsCache() GetCache2XXResponseDnsCache {
	if o == nil || IsNil(o.DnsCache) {
		var ret GetCache2XXResponseDnsCache
		return ret
	}
	return *o.DnsCache
}
...
// SetDnsCache gets a reference to the given GetCache2XXResponseDnsCache and assigns it to the DnsCache field.
...
func (o *GetCache2XXResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GetCache2XXResponse(varGetCache2XXResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "dnsCache")
