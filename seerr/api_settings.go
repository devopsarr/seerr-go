...
type ApiCreateCacheDnsFlushRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	dnsEntry string
}

func (r ApiCreateCacheDnsFlushRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateCacheDnsFlushExecute(r)
}

/*
CreateCacheDnsFlush Flush a specific DNS cache entry

Flushes a specific DNS cache entry

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param dnsEntry
 @return ApiCreateCacheDnsFlushRequest
*/
func (a *SettingsAPIService) CreateCacheDnsFlush(ctx context.Context, dnsEntry string) ApiCreateCacheDnsFlushRequest {
	return ApiCreateCacheDnsFlushRequest{
		ApiService: a,
		ctx: ctx,
		dnsEntry: dnsEntry,
...
func (a *SettingsAPIService) CreateCacheDnsFlushExecute(r ApiCreateCacheDnsFlushRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.CreateCacheDnsFlush")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/cache/dns/{dnsEntry}/flush"
	localVarPath = strings.Replace(localVarPath, "{"+"dnsEntry"+"}", url.PathEscape(parameterValueToString(r.dnsEntry, "dnsEntry")), -1)
...
type ApiCreateJellyfinRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	jellyfinSettings *JellyfinSettings
}

func (r ApiCreateJellyfinRequest) JellyfinSettings(jellyfinSettings JellyfinSettings) ApiCreateJellyfinRequest {
	r.jellyfinSettings = &jellyfinSettings
	return r
}

func (r ApiCreateJellyfinRequest) Execute() (*JellyfinSettings, *http.Response, error) {
	return r.ApiService.CreateJellyfinExecute(r)
}

/*
CreateJellyfin Update Jellyfin settings

Updates Jellyfin settings with the provided values.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateJellyfinRequest
*/
func (a *SettingsAPIService) CreateJellyfin(ctx context.Context) ApiCreateJellyfinRequest {
	return ApiCreateJellyfinRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) CreateJellyfinExecute(r ApiCreateJellyfinRequest) (*JellyfinSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.CreateJellyfin")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiCreateJellyfinSyncRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	createJellyfinSyncRequest *CreateJellyfinSyncRequest
}

func (r ApiCreateJellyfinSyncRequest) CreateJellyfinSyncRequest(createJellyfinSyncRequest CreateJellyfinSyncRequest) ApiCreateJellyfinSyncRequest {
	r.createJellyfinSyncRequest = &createJellyfinSyncRequest
	return r
}

func (r ApiCreateJellyfinSyncRequest) Execute() (*GetJellyfinSync2XXResponse, *http.Response, error) {
	return r.ApiService.CreateJellyfinSyncExecute(r)
}

/*
CreateJellyfinSync Start full Jellyfin library sync

Runs a full Jellyfin library sync and returns the progress in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateJellyfinSyncRequest
*/
func (a *SettingsAPIService) CreateJellyfinSync(ctx context.Context) ApiCreateJellyfinSyncRequest {
	return ApiCreateJellyfinSyncRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetJellyfinSync2XXResponse
func (a *SettingsAPIService) CreateJellyfinSyncExecute(r ApiCreateJellyfinSyncRequest) (*GetJellyfinSync2XXResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetJellyfinSync2XXResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.CreateJellyfinSync")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.createJellyfinSyncRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
func (r ApiCreateNetworkRequest) NetworkSettings(networkSettings NetworkSettings) ApiCreateNetworkRequest {
	r.networkSettings = &networkSettings
	return r
}

func (r ApiCreateNetworkRequest) Execute() (*NetworkSettings, *http.Response, error) {
	return r.ApiService.CreateNetworkExecute(r)
}

/*
CreateNetwork Update network settings
...
*/
func (a *SettingsAPIService) CreateNetwork(ctx context.Context) ApiCreateNetworkRequest {
	return ApiCreateNetworkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) CreateNetworkExecute(r ApiCreateNetworkRequest) (*NetworkSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NetworkSettings
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.CreateNetwork")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/network"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.networkSettings == nil {
		return localVarReturnValue, nil, reportError("networkSettings is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.networkSettings
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiCreateNotificationsNtfyRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	ntfySettings *NtfySettings
}

func (r ApiCreateNotificationsNtfyRequest) NtfySettings(ntfySettings NtfySettings) ApiCreateNotificationsNtfyRequest {
	r.ntfySettings = &ntfySettings
	return r
}

func (r ApiCreateNotificationsNtfyRequest) Execute() (*NtfySettings, *http.Response, error) {
	return r.ApiService.CreateNotificationsNtfyExecute(r)
}

/*
CreateNotificationsNtfy Update ntfy.sh notification settings

Update ntfy.sh notification settings with the provided values.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCreateNotificationsNtfyRequest
*/
func (a *SettingsAPIService) CreateNotificationsNtfy(ctx context.Context) ApiCreateNotificationsNtfyRequest {
	return ApiCreateNotificationsNtfyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return NtfySettings
func (a *SettingsAPIService) CreateNotificationsNtfyExecute(r ApiCreateNotificationsNtfyRequest) (*NtfySettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NtfySettings
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.CreateNotificationsNtfy")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/notifications/ntfy"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.ntfySettings == nil {
		return localVarReturnValue, nil, reportError("ntfySettings is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.ntfySettings
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
func (r ApiCreatePlexSyncRequest) CreateJellyfinSyncRequest(createJellyfinSyncRequest CreateJellyfinSyncRequest) ApiCreatePlexSyncRequest {
	r.createJellyfinSyncRequest = &createJellyfinSyncRequest
	return r
}
...
type ApiGetJellyfinRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiGetJellyfinRequest) Execute() (*JellyfinSettings, *http.Response, error) {
	return r.ApiService.GetJellyfinExecute(r)
}

/*
GetJellyfin Get Jellyfin settings

Retrieves current Jellyfin settings.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetJellyfinRequest
*/
func (a *SettingsAPIService) GetJellyfin(ctx context.Context) ApiGetJellyfinRequest {
	return ApiGetJellyfinRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return JellyfinSettings
func (a *SettingsAPIService) GetJellyfinExecute(r ApiGetJellyfinRequest) (*JellyfinSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.GetJellyfin")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetJellyfinSyncRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiGetJellyfinSyncRequest) Execute() (*GetJellyfinSync2XXResponse, *http.Response, error) {
	return r.ApiService.GetJellyfinSyncExecute(r)
}

/*
GetJellyfinSync Get status of full Jellyfin library sync

Returns sync progress in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetJellyfinSyncRequest
*/
func (a *SettingsAPIService) GetJellyfinSync(ctx context.Context) ApiGetJellyfinSyncRequest {
	return ApiGetJellyfinSyncRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GetJellyfinSync2XXResponse
func (a *SettingsAPIService) GetJellyfinSyncExecute(r ApiGetJellyfinSyncRequest) (*GetJellyfinSync2XXResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.GetJellyfinSync")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetMetadatasRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiGetMetadatasRequest) Execute() (*MetadataSettings, *http.Response, error) {
	return r.ApiService.GetMetadatasExecute(r)
}

/*
GetMetadatas Get Metadata settings

Retrieves current Metadata settings.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetMetadatasRequest
*/
func (a *SettingsAPIService) GetMetadatas(ctx context.Context) ApiGetMetadatasRequest {
	return ApiGetMetadatasRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) GetMetadatasExecute(r ApiGetMetadatasRequest) (*MetadataSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MetadataSettings
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.GetMetadatas")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/metadatas"
...
func (r ApiGetNetworkRequest) Execute() (*MainSettings, *http.Response, error) {
	return r.ApiService.GetNetworkExecute(r)
}

/*
GetNetwork Get network settings
...
*/
func (a *SettingsAPIService) GetNetwork(ctx context.Context) ApiGetNetworkRequest {
	return ApiGetNetworkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MainSettings
func (a *SettingsAPIService) GetNetworkExecute(r ApiGetNetworkRequest) (*MainSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.GetNetwork")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetNotificationsNtfyRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiGetNotificationsNtfyRequest) Execute() (*NtfySettings, *http.Response, error) {
	return r.ApiService.GetNotificationsNtfyExecute(r)
}

/*
GetNotificationsNtfy Get ntfy.sh notification settings

Returns current ntfy.sh notification settings in a JSON object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetNotificationsNtfyRequest
*/
func (a *SettingsAPIService) GetNotificationsNtfy(ctx context.Context) ApiGetNotificationsNtfyRequest {
	return ApiGetNotificationsNtfyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return NtfySettings
func (a *SettingsAPIService) GetNotificationsNtfyExecute(r ApiGetNotificationsNtfyRequest) (*NtfySettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.GetNotificationsNtfy")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiListJellyfinLibraryRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	sync *string
	enable *string
...
func (r ApiListJellyfinLibraryRequest) Sync(sync string) ApiListJellyfinLibraryRequest {
	r.sync = &sync
	return r
}

// Comma separated list of libraries to enable. Any libraries not passed will be disabled!
func (r ApiListJellyfinLibraryRequest) Enable(enable string) ApiListJellyfinLibraryRequest {
	r.enable = &enable
	return r
}

func (r ApiListJellyfinLibraryRequest) Execute() ([]JellyfinLibrary, *http.Response, error) {
	return r.ApiService.ListJellyfinLibraryExecute(r)
}

/*
ListJellyfinLibrary Get Jellyfin libraries

Returns a list of Jellyfin libraries in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListJellyfinLibraryRequest
*/
func (a *SettingsAPIService) ListJellyfinLibrary(ctx context.Context) ApiListJellyfinLibraryRequest {
	return ApiListJellyfinLibraryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) ListJellyfinLibraryExecute(r ApiListJellyfinLibraryRequest) ([]JellyfinLibrary, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.ListJellyfinLibrary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiListJellyfinUsersRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiListJellyfinUsersRequest) Execute() ([]ListJellyfinUsers2XXResponseInner, *http.Response, error) {
	return r.ApiService.ListJellyfinUsersExecute(r)
}

/*
ListJellyfinUsers Get Jellyfin Users

Returns a list of Jellyfin Users in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListJellyfinUsersRequest
*/
func (a *SettingsAPIService) ListJellyfinUsers(ctx context.Context) ApiListJellyfinUsersRequest {
	return ApiListJellyfinUsersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []ListJellyfinUsers2XXResponseInner
func (a *SettingsAPIService) ListJellyfinUsersExecute(r ApiListJellyfinUsersRequest) ([]ListJellyfinUsers2XXResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []ListJellyfinUsers2XXResponseInner
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.ListJellyfinUsers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPutMetadatasRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	metadataSettings *MetadataSettings
}

func (r ApiPutMetadatasRequest) MetadataSettings(metadataSettings MetadataSettings) ApiPutMetadatasRequest {
	r.metadataSettings = &metadataSettings
	return r
}

func (r ApiPutMetadatasRequest) Execute() (*MetadataSettings, *http.Response, error) {
	return r.ApiService.PutMetadatasExecute(r)
}

/*
PutMetadatas Update Metadata settings

Updates Metadata settings with the provided values.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPutMetadatasRequest
*/
func (a *SettingsAPIService) PutMetadatas(ctx context.Context) ApiPutMetadatasRequest {
	return ApiPutMetadatasRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MetadataSettings
func (a *SettingsAPIService) PutMetadatasExecute(r ApiPutMetadatasRequest) (*MetadataSettings, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.PutMetadatas")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.metadataSettings == nil {
		return localVarReturnValue, nil, reportError("metadataSettings is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.metadataSettings
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiTestMetadatasRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	testMetadatasRequest *TestMetadatasRequest
}

func (r ApiTestMetadatasRequest) TestMetadatasRequest(testMetadatasRequest TestMetadatasRequest) ApiTestMetadatasRequest {
	r.testMetadatasRequest = &testMetadatasRequest
	return r
}

func (r ApiTestMetadatasRequest) Execute() (*TestMetadatas2XXResponse, *http.Response, error) {
	return r.ApiService.TestMetadatasExecute(r)
}

/*
TestMetadatas Test Provider configuration

Tests if the TVDB configuration is valid. Returns a list of available languages on success.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiTestMetadatasRequest
*/
func (a *SettingsAPIService) TestMetadatas(ctx context.Context) ApiTestMetadatasRequest {
	return ApiTestMetadatasRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return TestMetadatas2XXResponse
func (a *SettingsAPIService) TestMetadatasExecute(r ApiTestMetadatasRequest) (*TestMetadatas2XXResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TestMetadatas2XXResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.TestMetadatas")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/metadatas/test"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.testMetadatasRequest == nil {
		return localVarReturnValue, nil, reportError("testMetadatasRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.testMetadatasRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiTestNotificationsNtfyRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	ntfySettings *NtfySettings
}

func (r ApiTestNotificationsNtfyRequest) NtfySettings(ntfySettings NtfySettings) ApiTestNotificationsNtfyRequest {
	r.ntfySettings = &ntfySettings
	return r
}

func (r ApiTestNotificationsNtfyRequest) Execute() (*http.Response, error) {
	return r.ApiService.TestNotificationsNtfyExecute(r)
}

/*
TestNotificationsNtfy Test ntfy.sh settings

Sends a test notification to the ntfy.sh agent.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiTestNotificationsNtfyRequest
*/
func (a *SettingsAPIService) TestNotificationsNtfy(ctx context.Context) ApiTestNotificationsNtfyRequest {
	return ApiTestNotificationsNtfyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SettingsAPIService) TestNotificationsNtfyExecute(r ApiTestNotificationsNtfyRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.TestNotificationsNtfy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/notifications/ntfy/test"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.ntfySettings == nil {
		return nil, reportError("ntfySettings is required and must be specified")
	}
